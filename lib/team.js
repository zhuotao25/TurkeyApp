...
var team = [
	member('zhuotao25', 'Zhuotao', 'Huang', 'junior', 'pppp'),
	member('chetinglin', 'Che-Ting', 'Lin', 'junior', 'pppp'),
	member('egendreau', 'Eric', 'Gendreau', 'junior', 'pppp'),
	member('JingLiu122', 'Jing', 'Liu', 'senior', 'pppp'),
	member('ralren', 'Ren', 'Delos Reyes', 'senior', 'pppp'),
	member('xliu3', 'Xin', 'Liu', 'senior', 'pppp')
];
