...
var team = [
	member('zhuotao25', 'Zhuotao', 'Huang', 'junior', fs.readFileSync('./src/profile_zhuotao.txt')),
	member('chetinglin', 'Che-Ting', 'Lin', 'junior', fs.readFileSync('./src/profile_cheting.txt')),
	member('egendreau', 'Eric', 'Gendreau', 'junior', fs.readFileSync('./src/profile_eric.txt')),
	member('JingLiu122', 'Jing', 'Liu', 'senior', fs.readFileSync('./src/profile_jing.txt')),
	member('ralren', 'Ren', 'Delos Reyes', 'senior', fs.readFileSync('./src/profile_ren.txt')),
	member('xliu3', 'Xin', 'Liu', 'senior', fs.readFileSync('./src/profile_xin.txt'))
];
